# training setting
method=${1:-"ReplanGaussian_BC"}
seed="0"
train_gpu=${2:-"0,1"}
train_gpu_list=(${train_gpu//,/ })
port=${3:-"12360"}
use_wandb=True
wandb_project="ReplanGaussian_BC-peract"
wandb_group="A800"
wandb_name="ReplanGaussian_BC"
batch_size=1
num_workers=6
...
base_dir="/results/ReplanGaussian/peract"
...
method.neural_renderer.lambda_rec=${dynamic_lambda_rec} \
